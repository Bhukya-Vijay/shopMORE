...
router.post("/", async (req, res) => {
    ...
    try {
        ...
        console.error(error)
        res.status(404).json({ success: false, message: "Product add to cart failed" })
    }
})
        ...
        if (guestCart) {
            ...
            if (userCart) {
                ...
                guestCart.products.forEach((guestItem) => {
                    ...
                    if (productIndex > -1) {
                        // If the products exists in the user cart, update the quantity
                ...
                // If the user cart has no existing cart, assign the guest cart to the user
