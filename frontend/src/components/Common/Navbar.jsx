    ...
    return (
        <>
            <nav className="container mx-auto flex items-center justify-between py-4 px-6">
                {/* Left Logo */}
                <div>
                    <Link to="/" className="text-2xl font-medium">shopMORE</Link>
                </div>
                ...
                <div className="flex items-center space-x-4">
                    ...
                    <button className="relative hover:text-black" onClick={toggleCartDrawer}>
                        ...
                        {cartItemCount > 0 && (
                            <span className="absolute bg-[#ea2e0e] text-white text-xs rounded-full px-1.5 py-0.3 -top-1">{cartItemCount}</span>
                        )}
            ...
            transition-transform duration-300 flex flex-col z-50 md:hidden  ${navDrawerOpen ? "translate-x-0" : "-translate-x-full"}`}>
                ...
                <div className="p-4">
                    <h2 className="text-xl font-semibold mb-4 border-b border-gray-200">Menu</h2>
