    ...
    <footer className="py-12">
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-0">
            <div>
                ...
                {/* Newsletter Form */}
                <form className="flex">
                    <input type="email" placeholder="Enter your email" className="p-3 w-full border text-sm border-l border-gray-300 rounded-l-md focus:outline-none focus:ring-2 focus:ring-gray-500 transition-all" required />
                    <button type="submit" className="bg-black text-white p-x-6 p-y-3 text-sm rounded-r-md hover:bg-gray-800 transition-all cursor-pointer">Subscribe</button>
                </form>
            </div>
            {/* Shop Links */}
            <div>
              ...
              <div>
                  ...
                  <ul className="space-y-2 text-gray-600">
                      ...
                      <li>
                          <Link to="#" className="hover:text-gray-500 transition-colors">FAQ'sr</Link>
                      </li>
                      <li>
              ...
              <div>
                ...
                <div className="flex items-center space-x-4 mb-6">
                    <a href="https://www.facebook.com" target="_black" rel="noopener noreferrer" className="hover:text-gray-500">
