            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="mb-6">
                    ...
                    <input type="text" name="name" value={productData.name} onChange={handleChange}
                        className="w-full border-1 border-gray-300 rounded-md p-2" required />
                </div>
                {/* Description */}
                <div className="mb-6">
                    <label className="block font-semibold mb-2">Product Description</label>
                    <textarea name="description" value={productData.description} rows={4} onChange={handleChange}
                        className="w-full border-1 border-gray-300 rounded-md p-2" required />
                </div>
                {/* Price */}
                <div className="mb-6">
                ...
                <div className="mb-6">
                    ...
                    <input type="file" onChange={handleImageUpload} className="bg-gray-100 rounded border-1 border-gray-600 w-50 p-1" />
