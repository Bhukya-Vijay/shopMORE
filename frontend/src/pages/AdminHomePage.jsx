...
import { fetchAdminProducts } from '../Redux/Slice/adminProductSlice.js'
import { fetchAllOrders } from '../Redux/Slice/adminOrderSlice.js'
    ...
    return (
        <div className="max-w-7xl mx-auto p-6">
            ...
            {productsLoading || ordersLoading ? (
                <p>Loading......</p>
            ) : productsError ? (<p>Error fetching products: {productsError}</p>) : ordersError ? (<p>Error fetching Orders: {ordersError}</p>) :
                            ...
                            {orders && orders.length > 0 ? (
                                orders.map((order) => (
                                    <tr key={order._id} className="border-b border-gray-300 hover:bg-gray-50 cursor-pointer">
                                        ...
                                        <td className="p-4">{order.user?.name || "No Name"}</td>
